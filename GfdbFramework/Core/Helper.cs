...
namespace GfdbFramework.Core
{
    ...
    public static class Helper
    {
        ...
        private static readonly Type _ModifiableMultipleJoinType = typeof(ModifiableMultipleJoin<int, int, int>).GetGenericTypeDefinition();
        ...
        private static readonly string _MultipleJoinJoinMethodName = nameof(MultipleJoin<int, int>.Join);
        private static readonly string _MultipleJoinInnerJoinMethodName = nameof(MultipleJoin<int, int>.InnerJoin);
        private static readonly string _MultipleJoinLeftJoinMethodName = nameof(MultipleJoin<int, int>.LeftJoin);
        private static readonly string _MultipleJoinRightJoinMethodName = nameof(MultipleJoin<int, int>.RightJoin);
        private static readonly string _MultipleJoinFullJoinMethodName = nameof(MultipleJoin<int, int>.FullJoin);
        private static readonly string _MultipleJoinCrossJoinMethodName = nameof(MultipleJoin<int, int>.CrossJoin);
        private static readonly string _MultipleJoinSelectMethodName = nameof(MultipleJoin<int, int>.Select);
